...
import { codeMode, architectMode, askMode } from "./modes";
...
export async function addCustomInstructions(customInstructions, cwd, preferredLanguage) {
...
export const SYSTEM_PROMPT = async (cwd, supportsComputerUse, mcpHub, diffStrategy, browserViewportSize, mode = codeMode) => {
    switch (mode) {
        case architectMode:
