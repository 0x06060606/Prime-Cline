...
export function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("roo-cline.plusButtonClicked", async () => {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("roo-cline.settingsButtonClicked", () => {
        //vscode.window.showInformationMessage(message)
        sidebarProvider.postMessageToWebview({ type: "action", action: "settingsButtonClicked" });
    }));
    context.subscriptions.push(vscode.commands.registerCommand("roo-cline.historyButtonClicked", () => {
